...
class Transformer {
  ...
  injectConstructor(injectableName, namespace, shortNs) {
    return this.addConstructorParam(injectableName, '!' + shortNs)
        .addGoogRequire(shortNs, namespace);
  }
  ...
  addConstructorParam(identifier, type) {
    ...
    if (path) {
      ...
      // Add variable to the body of the constructor.
